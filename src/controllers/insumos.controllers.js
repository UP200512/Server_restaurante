...
export const getInsumos = async (req, res) => {
    try {
        const [rows] = await pool.query('select id_insumo, i.nombre, i.tipo_insumo_id, t.nombre as nombre_tipo, i.unidad_de_medida_id, u.nombre as nombre_unidad,  u.abreviacion, descripcion, cantidad from insumos i inner join tipos_de_insumo t on i.tipo_insumo_id = t.id_tipo inner join  unidades_de_medida u on i.unidad_de_medida_id = u.id_unidad order by id_insumo;');
